...
data <- model.single.pop.with.recent.population.change.tMRCA(100, 5000, 2000, 10000)
iicr(data)
...
ne_bottleneck <- 200
time_change_population_size <- 2000
time_duration_bottleneck <- 50
number_of_blocks <- 1000

data2 <- model.single.pop.with.bottleneck.tMRCA(population_size_in_present, ne_bottleneck, time_change_population_size, time_duration_bottleneck, number_of_blocks)
iicr(data2)
...
ne_bottleneck <- 10000
time_change_population_size <- 500
time_duration_bottleneck <- 15
number_of_blocks <- 1000
